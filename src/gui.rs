...
use specs::prelude::*;
use super::{CombatStats, Player, gamelog::GameLog, Map, Name, Position, Point, State, InBackpack, 
            Viewshed, RunState, Equipped, HungerClock, HungerState, rex_assets::RexAssets, Hidden, camera};
...
pub fn draw_ui(ecs: &World, ctx : &mut Rltk) {
    ...
    let depth = format!("Pietro: {}", map.depth);
