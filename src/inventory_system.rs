use specs::prelude::*;
use crate::{Potion, CombatStats, WantsToDropItem};
            ...
            match potion {
                ...
                Some(potion) => {
                    ...
                    if entity == *player_entity {
                        gamelog.entries.push(format!("Wieclaw zjada {} i odzyskuje {} HP.", names.get(drink.potion).unwrap().name, potion.heal_amount));
                    }
