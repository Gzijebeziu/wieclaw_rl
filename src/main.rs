use rltk::{GameState, RGB, Rltk, RandomNumberGenerator, Point};
use specs::prelude::*;
mod components;
pub use components::*;
mod map;
...
fn main() -> rltk::BError {
    ...
    let context = RltkBuilder::new()
        ...
        .with_fancy_console(80, 50, "curses_square_16x16.png")
        .with_vsync(false)
        .build()?;
    ...
    for (i,room) in map.rooms.iter().skip(1).enumerate() {
        ...
        match roll {
            1 => { glyph = rltk::to_cp437('g'); name = "Gnomon".to_string(); }
            _ => { glyph = rltk::to_cp437('G'); name = "Golem Zoledny".to_string(); }
        }
