...
pub fn random_builder(new_depth : i32) -> Box<dyn MapBuilder> {
    ...
    match builder {
        ...
        2 => { result = Box::new(SimpleMapBuilder::new(new_depth)); }
        3 => { result = Box::new(BspInteriorBuilder::new(new_depth)); }
        ...
        7 => { result = Box::new(DrunkardsWalkBuilder::winding_passages(new_depth)); }
        8 => { result = Box::new(MazeBuilder::new(new_depth)); }
        9 => { result = Box::new(DLABuilder::walk_inwards(new_depth)); }
        10 => { result = Box::new(DLABuilder::walk_outwards(new_depth)); }
        11 => { result = Box::new(DLABuilder::central_attractor(new_depth)); }
        12 => { result = Box::new(DLABuilder::insectoid(new_depth)); }
