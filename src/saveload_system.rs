use specs::{prelude::*, saveload::{SimpleMarker, SimpleMarkerAllocator, SerializeComponents, DeserializeComponents, MarkedBuilder}, error::NoError};
use super::components::*;
use std::{fs::File, path::Path, fs::{self, read_to_string}};
...
pub fn save_game(ecs : &mut World) {
...

    {
        ...
        serialize_individually!(ecs, serializer, data, Position, Renderable, Player, Viewshed, Monster, Name, BlocksTile,
            ...
            SerializationHelper, Equippable, Equipped, MeleePowerBonus, DefenseBonus, WantsToRemoveItem
        );
    }
...
pub fn load_game(ecs: &mut World) {
...

    {
        ...
        deserialize_individually!(ecs, de, d, Position, Renderable, Player, Viewshed, Monster, Name, BlocksTile, CombatStats,
            ...
            WantsToPickupItem, WantsToUseItem, WantsToDropItem, SerializationHelper, Equippable, Equipped, MeleePowerBonus, DefenseBonus, WantsToRemoveItem
        );
    }
